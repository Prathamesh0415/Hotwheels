...
function Page5() {
  return (
    <div className="relative min-h-screen bg-[#0a3b5c] overflow-hidden">
      ...
      <div className="w-60 sm:w-[374.03px] h-28 sm:h-[186.01px] absolute top-[150px] sm:top-[200px] left-1/2 transform -translate-x-1/2 rotate-[20.08deg]">
        <img
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 w-60 sm:w-[348.63px] h-40 sm:h-[261.47px] rotate-[-20.08deg]">
        <img
